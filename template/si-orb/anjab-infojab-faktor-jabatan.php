 <?php
  $pageTitle = "ANJAB: Informasi Faktor Jabatan - SI-ORB";
  ob_start();
 ...
 <div class="page-body">
   <div class="container-fluid">
     <div class="page-title">
       <div class="row">
         <div class="col-sm-6">
           <h3>Informasi Faktor Jabatan</h3>
         </div>
         <div class="col-sm-6">
           <ol class="breadcrumb">
                       ...
                       <tr class="product-removes inbox-data">
                         ...
                         <td>
                           <div class="common-align gap-2 justify-content-start">
                             ...
                             <a href="./anjab-infojab-faktor-jabatan-edit.php#edit-<?= urlencode($item['nama_jabatan']) ?>">
