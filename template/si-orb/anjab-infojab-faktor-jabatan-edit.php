 <?php
  $pageTitle = "ANJAB: Edit Informasi Faktor Jabatan - SI-ORB";
  ob_start();
 ...
 <div class="page-body">
   <div class="container-fluid">
     <div class="page-title">
       <div class="row">
         <div class="col-sm-6">
           <h3>Edit Informasi Faktor Jabatan: Nama Jabatan</h3>
         </div>
         <div class="col-sm-6">
           <ol class="breadcrumb">
             ...
             <li class="breadcrumb-item"><a href="./anjab-infojab-faktor-jabatan.php">Informasi Faktor Jabatan</a></li>
   ...
   <div class="container-fluid">
     <div class="row">
       ...
       <div class="col-md-12">
         <div class="card">
           <div class="card-header pb-0">
             <h5>Informasi Faktor Jabatan</h5>
           </div>
           <div class="card-body">
             <div class="col-md-12">
               <?php
