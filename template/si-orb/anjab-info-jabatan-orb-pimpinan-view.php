       ...
       <div class="row">
         ...
         <div class="col-sm-6">
           <ol class="breadcrumb">
             ...
             <li class="breadcrumb-item"><a href="./anjab-info-jabatan-orb-pimpinan.php">Info Jabatan</a></li>
               ...
               <div class="blog-box blog-details">
                 <div class="blog-details">
                   <ul style="display: flex; gap: 1rem; margin-top: 1rem;">
                     ...
                     <li>
                       <span class="badge bg-info text-dark">Menunggu Persetujuan Kepala Biro ORB</span>
                     </li>
                   </ul>
                   <div>
                     <h5>Nama Jabatan</h5>
                         ...
                         <div class="card height-equal">
                           ...
                           <div
                             ...
                             <ul>
                               ...
                               <li class="d-flex">
                                 <div
                                   class="timeline-dot-danger"></div>
                                 <div class="w-100 ms-3">
                                   <p
                                     class="d-flex gap-2 mb-2">
                                     <span
                                       class="date-content light-background">25 Dec 2024</span><span class="date-content light-background">6:56 AM</span>
                                   </p>
                                   <h6 class="mb-0">
                                     Biro ORB
                                     <span
                               ...
                               <li class="d-flex">
                                 ...
                                 <div class="w-100 ms-3">
                                   <p
                                     class="d-flex gap-2 mb-2">
                                     <span
                                       class="date-content light-background">25 Dec 2024</span><span class="date-content light-background">10:56 AM</span>
                                   </p>
                                   <h6 class="mb-0">
                                     Kepala Biro ORB
                                     <span
                                   ...
                                   <p class="f-light">
                                     Melihat Laporan Form Info Jabatan
                                   </p>
                                 </div>
                               </li>
                             </ul>
