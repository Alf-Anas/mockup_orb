   ...
   <div class="container-fluid">
     <div class="row general-widget-wrapper">
         ...
         <div class="card widget-1">
           <div class="card-body">
             <div class="widget-content">
               ...
               <div>
                 <h4><span class="counter" data-target="420">0</span>
                 </h4>
                 <span class="f-light">Perangkat Daerah</span>
               </div>
             </div>
           ...
           <div class="card-body">
             <div class="widget-content">
               ...
               <div>
                 ...
                 <span class="f-light">Jabatan</span>
               </div>
             </div>
           ...
           <div class="card-body">
             <div class="widget-content">
               ...
               <div>
                 ...
                 <span class="f-light">Indeks Capaian</span>
               </div>
             </div>
             <div class="font-danger f-w-500">
               <i class="bookmark-search me-1" data-feather="trending-down"></i>
           ...
           <div class="card-body">
             <div class="widget-content">
               ...
               <div>
                 ...
                 <span class="f-light">Formasi Jabatan</span>
               </div>
             </div>
             <div class="font-success f-w-500">
               <i class="bookmark-search me-1" data-feather="trending-up"></i>
       ...
       <div class="col-xl-7 col-lg-12 box-col-6">
         <div class="card">
           <div class="card-header">
             <h5>Realisasi Formasi Jabatan</h5>
           </div>
           <div class="card-body">
