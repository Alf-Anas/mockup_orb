 <?php
  $pageTitle = "ANJAB: Kategori Jabatan - SI-ORB";
  ob_start();

  $kategoriJabatan = [
    ["no" => 1, "kategori_jabatan" => "Jabatan Struktural"],
    ["no" => 2, "kategori_jabatan" => "Jabatan Fungsional"],
    ["no" => 3, "kategori_jabatan" => "Jabatan Pelaksana"],
    ["no" => 4, "kategori_jabatan" => "Jabatan Pimpinan Tinggi"],
    ["no" => 5, "kategori_jabatan" => "Jabatan Teknis"],
  ];
                 ...
                 <table class="table" id="project-status">
                   <thead>
                     <tr>
                       ...
                       <th><span class="c-o-light f-w-600">Kategori Jabatan</span></th>
                   ...
                   <tbody>
                     <?php foreach ($kategoriJabatan as $item): ?>
                       <tr class="product-removes inbox-data">
                         ...
                         <td>
                           <p><?= $item['kategori_jabatan'] ?></p>
                         </td>
                         <td>
                           <div class="common-align gap-2 justify-content-start">
                             <a href="#edit-<?= urlencode($item['kategori_jabatan']) ?>"
                               data-bs-toggle="modal"
                               data-bs-target="#exampleModalCenter1">
             ...
             <div class="row">
               <div class="col-12 col-lg-12">
                 <form class="row g-3 " novalidate="">
                   <div class="col-12">
                     <label class="form-label" for="projectName">Kategori Jabatan</label>
